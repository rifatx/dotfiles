...
alias tor_start='/usr/bin/systemctl start tor.service'
alias tor_stop='/usr/bin/systemctl stop tor.service'
alias tor_restart='/usr/bin/systemctl restart tor.service'
